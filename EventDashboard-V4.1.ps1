...
.kb-secondary-actions{margin-top:8px;display:flex;gap:6px;flex-wrap:wrap;}
.kb-link-small{display:inline-block;padding:3px 9px;background:var(--bg-input);color:var(--text-muted);border:1px solid var(--border);border-radius:5px;font-size:.68rem;font-weight:500;text-decoration:none;transition:all .2s;}
.kb-link-small:hover{border-color:var(--highlight);color:var(--highlight);}
